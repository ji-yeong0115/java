...
public class Page {
	...
	private int pagingBarSize = 10;	// 화면에 보여질 페이징바의 페이지 개수
	...
	private void makePageInfo() {
		...
		// limit가 10일 때
		// 게시글이 100개일 경우 필요한 페이지의 수 ? 10
		// 게시글이 101개일 경우 필요한 페이지의 수 ? 11
		...
		// 페이징바의 크기가 10인 경우 끝 페이지의 번호는
		// 10, 20, 30, 40, . . .
		if(endPage > maxPage) { // endPage가 maxPage보다 클 경우
			endPage = maxPage;
		}else {
